                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Form-->
                            {{ Form::model($admin, [ 'method' => 'POST','route' => ['admin-update', $admin->id],'class'=>'form' ,"id"=>"admin_update_form", 'enctype'=>'multipart/form-data'])}}
                            @csrf
                                <!--begin::Input group-->
...
{{--                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the contact's company name (optional)."></i>--}}
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{"admin.dashboard"}}"  class="btn btn-light me-3">Back</a>
                                    <!--end::Button-->
                                    <!--begin::Button-->
