												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion menu-sub-indention">
														...
														<div class="menu-sub menu-sub-accordion">
															...
															<div class="menu-item">
																<!--begin:Menu link-->
																<a class="menu-link active" href="../../demo1/dist/apps/ecommerce/reports/shipping.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_633f096bcd219">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_633f096bcd219" data-allow-clear="true">
																<option></option>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_shipping_table">
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0068326</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0026184</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0029945</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0058385</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0035483</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0047989</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0055195</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0068261</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0046762</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0050787</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0030215</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0054756</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0039905</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0062232</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0043930</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0042821</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0043872</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0061198</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0047687</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0047114</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0031522</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0041980</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0057558</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0035159</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0048156</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0052787</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0042285</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0060565</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0064279</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0062852</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0062539</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0065699</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0048500</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0041150</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0060377</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0066269</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0037304</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0033638</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0046888</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0047870</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0048733</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0059427</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0039537</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0050507</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0035791</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0069645</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0033156</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0050073</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
													...
													<tr>
														...
														<!--begin::Shipping ID=-->
														<td>
															<a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-dark text-hover-primary">#SHP-0032003</a>
														</td>
														<!--end::Shipping ID=-->
														<!--begin::Status=-->
														<td>
